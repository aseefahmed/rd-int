$(document).ready(function() {
    ...
    setTimeout(function() {
        /*toastr.options= {
            closeButton: !0, progressBar: !0, showMethod: "slideDown", timeOut: 4e3
        }
        , toastr.success("Your trusted Partner", "Welcome to UDDL")*/
    }
    , 1300), $(".count-number").counterUp( {
        delay: 10, time: 5e3
    }
    ), $(".chat_list").slimScroll( {
        size: "3px", height: "296px", allowPageScroll: !0, railVisible: !0
    }
    ), $(".message_inner").slimScroll( {
        size: "3px", height: "351px", allowPageScroll: !0, railVisible: !0
    }
    ), $(".monthly_calender").slimScroll( {
        size: "3px", height: "310px", allowPageScroll: !0, railVisible: !0
    }
    ), $(".emojionearea").emojioneArea( {
        pickerPosition: "top", tonesStyle: "radio"
    }
    ), $("#m_calendar").monthly( {
        mode: "event", xmlUrl: "events.xml"
    }
        ...
        type: "line", lineColor: "#558B2F", fillColor: "#558B2F", width: "100", height: "20"
    }
    ), $(".sparkline6").sparkline([4, 6, 7, 7, 4, 3, 2, 1, 4, 4, 5, 6, 3, 4, 5, 8, 7, 6, 9, 3, 2, 4, 1, 5, 6, 4, 3, 7], {
        type: "discrete", lineColor: "#558B2F", width: "100", height: "20"
    }
    ), $(".sparkline7").sparkline([5, 6, 7, 2, 0, -4, -2, 4, 5, 6, 3, 2, 4, -6, -5, -4, 6, 5, 4, 3], {
        type: "bar", barColor: "#558B2F", negBarColor: "#c6c6c6", width: "100", height: "20"
    }
    );
