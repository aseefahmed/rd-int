...
@section('content')
    <div class="row" ng-controller="BuyingOrderController" ng-init="ordersSummery()">
        <div class="col-sm-12">
            ...
            <a class="waves-effect waves-light btn modal-trigger" href="#add-supplier-modal"> Add Supplier</a>
            ...
            <!-- <div class="col-sm-6 text-right">
                <div class="fixed-action-btn horizontal">
                    ...
                    <ul>
                        ...
                        <li><a class="waves-effect waves-light btn modal-trigger btn-floating red" href="#add-supplier-modal"><i class="large mdi-content-add"></i></a></li>
                    </ul>
                </div>
            </div> -->
                        ...
                        <tbody>
                            @foreach($suppliers as $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('buying/supplier/'.$supplier->id) }}" class="waves-effect waves-light light-blue darken-4  btn"><i class="mdi-image-remove-red-eye"></i></a>
        ...
        <div id="add-supplier-modal" class="modal modal-fixed-footer">
            <div class="modal-content">
                 <button class="btn waves-effect waves-light green darken-1" >Add Supplier</button>
                <form class="col s12" name="myForm">
                    <div class="row">
                        <div class="input-field col s6">
                            <input ng-model="order.supplier_name" name="supplier_name" type="text">
            ...
            <div class="modal-footer green lighten-4">
                ...
                <a href="#" class="waves-effect waves-light light-blue btn modal-action modal-close" ng-click="add_supplier(myForm)">Add</a>
            </div>
        </div>
    </div>
@endsection